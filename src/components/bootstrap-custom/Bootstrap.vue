    ...
    <main>
      <div class="container">
        ...
        <main class="py- lead">
          ...
          <p>
            BootstrapLite is a barebones version of bootstrap that gives designers and developers a bit more control of what parts of bootstrap apps require and when. Reducing the bolat and boilerplate and allowing for customization and flexibility using bootstrap built in mixins and functions.
          </p>
...
@import '~bootstrap/scss/_grid.scss';
        ...
        <div class="text-center section py-5">
          <a
            href="/guide"
            class="m-2 support-links btn elm-quarter btn-lg blacktie-primary-elm rounded oswald"
            target="_blank"
          >
            Read The Guide
          </a>
    ...
    <div class="elm-bg-gray-dark-">
      <div class="section elm-color-whitesmoke-">
        <div
          class="text-center text-uppercase attributions col-xs-1 is-size-6"
        >
          <p>
            <a href="/">
              <img
                src="/images/blk-logo.png"
                alt=""
                srcset=""
              >
            </a>
          ...
          <a
            ...
            target="_blank"
            class="support-links btn is-rounded is-small"
          >
            Components
          </a>
          <a
          ...
          <button class="btn is-rounded is-small">
            Beta
          </button>
        </div>
      </div>
